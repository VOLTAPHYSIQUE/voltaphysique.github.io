    ...
    if (type === 'tracker') {
        ...
        if (updatesData) {
            ...
            tbody.innerHTML = sortedNames.map(name => {
                ...
                `;
            }).join('') || '<tr><td colspan="6" class="p-4 text-center text-gray-500">No weekly updates found.</td></tr>';
        } else {
            tbody.innerHTML = '<tr><td colspan="6" class="p-4 text-center text-gray-500">Loading weekly updates...</td></tr>';
        }
